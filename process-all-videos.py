...
FOLDER = '/bluesclues-data/home/pingpong-nima/robot_table_tennis/pipeline_outputs/shared/batch_clipped_long_1_dvij'
SAMPLE_RATIO = 1.
...
for folder in LIST : #tqdm.tqdm(folder_list):
    n += 1
    if os.path.isdir(os.path.join(FOLDER, folder)):
        print('Processing folder:', folder)
